...
func Init(_dbLogger logger.DbLogger) {
	...
	r.HandleFunc("/articles/{id}/like", articlesLikeHandler).Methods("POST")
	r.HandleFunc("/articles/{id}/dislike", articlesDislikeHandler).Methods("POST")
	r.HandleFunc("/articles/{id}/comments", articlesCommentsHandler).Methods("POST")
