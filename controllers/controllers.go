...
func Init(_repository domain.MainRepository) {
	...
	r.HandleFunc("/articles/users", usersActivityArticlesHandler).Methods("GET")
	...
	r.HandleFunc("/articles/{articleId}/comments/{commentId}", articlesDeleteCommentsHandler).Methods("DELETE")
